...
basic_test: test/basic-test.cpp
	$(CC) test/basic-test.cpp -I$(GTEST_INCLUDE_PATH) -L$(GTEST_LIB_PATH) -lgtest -lpthread -o basic_test

calculation_test: test/calculation-test.cpp
	$(CC) test/calculation-test.cpp -I$(GTEST_INCLUDE_PATH) -L$(GTEST_LIB_PATH) -lgtest -lpthread -o calculation_test
